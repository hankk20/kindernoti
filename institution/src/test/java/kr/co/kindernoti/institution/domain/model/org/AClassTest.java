...
class AClassTest {
    ...
    void testAddTeacher() {
        Teacher mainTeacher = new Teacher(institution.getId(), Account.of("user", "홍길동", "", null, null));
        Teacher subTeacher = new Teacher(institution.getId(), Account.of("user", "김길동", "", null, null));
