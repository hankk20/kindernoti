...
import kr.co.kindernoti.institution.interfaces.rest.organization.ManagerInstitutionController;
...
@WebFluxTest({ManagerInstitutionController.class, InstitutionInterfaceMapper.class})
@AutoConfigureRestDocs
class ManagerInstitutionControllerTest {
    ...
    void testInstitutionUpdateForManager() {
        ...
        client.mutateWith(SecurityMockServerConfigurers.csrf())
                .patch()
                .uri("/manager/institutions/{institutionId}", testData.getId().toString())
